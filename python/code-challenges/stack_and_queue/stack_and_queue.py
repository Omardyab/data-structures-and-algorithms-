...
#  To run this go inside Pyhton=> code-challenges,  then type this command python -m stack_and_queue.stack_and_queue
...
if __name__ == "__main__":
    ...
    # top is last item which is Lucy
    print(stack1)
    # remove top item Lucy
    stack1.pop()
    print(stack1)

    queue1 = Queue()
    queue1.enqueue(4)
    print("adding new front one ", queue1)
    queue1.enqueue(5)
    queue1.enqueue(66)
    queue1.enqueue("dario")
    print("adding new front one ", queue1)
    print(queue1)
    print("removing one ",queue1.dequeue())
    print(queue1)
    print("front is ",queue1.peek())
